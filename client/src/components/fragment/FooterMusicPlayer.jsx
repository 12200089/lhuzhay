...
function FooterMusicPlayer({music}) {
    ...
    const [{id, name, author, img, song}, setCurrTrack] = useState(music);
    ...
    return (
        <div style={useStyle.component} className={"footer-player"}>
            ...
            <div className="playback-controls">
                ...
                <audio ref={audioElement} src={`http://localhost:5000/image/${song}`} preload={"metadata"}/>
